...
const confidenceBoosters = [
  ...
  "You're the moment 💖",
  "Born to shine, darling 🌠",
  "Pure elegance personified 🕊️",
  "Breathtaking, simply breathtaking 💐",
  "You're a vision in bloom 🌸",
  "Golden hour has nothing on you 🌅",
  "Sculpted by light itself 🤍",
  "Timeless, refined, unforgettable 🥂",
  "That glow? Iconic. 💋",
  "Soft power, loud beauty 🌹",
  "You make ordinary look exquisite 🪞",
  "Walking poetry, head to toe 📜",
  "Magnetic from every angle 🧲",
  "Lit from within, divine without 🔆",
  "A whole mood, a whole moment 🎭",
  "Couture-level confidence 👗",
  "Quietly devastating beauty 🖤",
  "You're the soft launch of greatness 🚀",
  "Even mirrors do a double take 🪩",
  "Serving silk-and-honey realness 🍯",
  "Radiant, regal, real 👑",
  "Your aura is on a runway 💃",
  "Skin like satin, soul like gold ✨",
  "Pure beauty in slow motion 🎞️",
  "Heart-stoppingly beautiful 💗",
  "Made of stardust and softness 🌌",
];
