...
const StylingFlowPage = () => {
  ...
  // Reset palette selection if upstream choices change
  useEffect(() => {
    setSelectedPaletteId(null);
  }, [outfitSelections, selectedVibe, selectedSkin]);

  // Final makeup config = chosen palette merged with skin + style
